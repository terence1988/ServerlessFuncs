...
namespace ServerlessFuncs
{
    ...
    public static class TodoApi
    {
           ...
           ILogger log)
        {
            ...
            //Version 5.x of the Storage extension NuGet package and version 3.x of the extension bundle currently do not include the Table Storage bindings
            //Iloger change
            // Table as in cosmos Table API
